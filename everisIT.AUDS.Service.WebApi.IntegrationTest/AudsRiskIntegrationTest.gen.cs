...
namespace everisIT.AUDS.Service.WebApi.IntegrationTest
{
    ...
    public partial class AudsRiskIntegrationTest
    {
        private readonly HttpClient testClient;
        private readonly string requestURI;
        public AudsRiskIntegrationTest()
        {
            requestURI = "/api/v1/AudsRisk";
            testClient = ServerTestSingleton.instanceUnique.clientTest;
        }

        [Fact]
        [Trait("Category", "IntegrationTest")]
        [Trait("Category", "AudsRisk")]
        [Trait("Category", "GetList")]
        [Trait("Category", "OK")]
        public void GetList_AudsRisk_Return_OK_Filtered_By_Active_CodeStatus()
        {
            //Arrange
            var filter = new Infrastructure.Filters.AudsRiskFilter()
            {
                CodeStatus = true
            };
            ...
            var parsedResult = JsonConvert.DeserializeObject<List<AudsRiskDto>>(result.Content.ReadAsStringAsync().Result);
            //Assert
        ...
        [Trait("Category", "GetList")]
        [Trait("Category", "OK")]
        public void GetList_All_AudsRisk_Return_OK()
        {
            //Action
        ...
        [Trait("Category", "OK")]
        public void Get_AudsRisk_By_Id_Return_OK()
        {
            //Arrange
            var resultGetAll = testClient.GetAsync(requestURI).Result;
            var idAudsRisk = JsonConvert.DeserializeObject<List<AudsRiskDto>>(resultGetAll.Content.ReadAsStringAsync().Result).FirstOrDefault().RiskId;
            //Action
            var result = testClient.GetAsync($"{requestURI}/{idAudsRisk}").Result;
            var parsedResult = JsonConvert.DeserializeObject<AudsRiskDto>(result.Content.ReadAsStringAsync().Result);
            //Assert
            Assert.True(result.IsSuccessStatusCode);
            Assert.True(result.StatusCode == HttpStatusCode.OK);
            Assert.Equal(idAudsRisk, parsedResult.RiskId);
        }
        ...
        [Trait("Category", "GetById")]
        [Trait("Category", "KO")]
        public void Get_AudsRisk_By_Id_Return_BadRequest_When_Id_Is_Zero()
        {
            //Arrange
            int id = 0;
            //Action
        ...
        [Trait("Category", "KO")]
        public void Create_AudsRisk_Return_UnsupportedMediaType_With_Null_Object_Parameter()
        {
            //Action
        ...
        [Trait("Category", "KO")]
        public void Delete_AudsRisk_Return_NotFound_When_CodeStatus_Is_Inactive()
        {
            //Arrange
            var listAllEntityDto = testClient.GetAsync(requestURI).Result;
            var entityDto = JsonConvert.DeserializeObject<List<AudsRiskDto>>(listAllEntityDto.Content.ReadAsStringAsync().Result)
                .Where(audsRisk => audsRisk.CodeStatus == false)
                .OrderByDescending(x => x.RiskId).First();

            //Action
            var returned = testClient.DeleteAsync($"{requestURI}/{entityDto.RiskId}").Result;
            //Assert
            Assert.False(returned.IsSuccessStatusCode);
        ...
        [Trait("Category", "Delete")]
        [Trait("Category", "KO")]
        public void Delete_AudsRisk_Return_BadRequest_When_Id_Is_Negative()
        {
            var idNotExist = -1;
            //Action
        ...
        [Trait("Category", "KO")]
        public void Update_AudsRisk_Return_UnsupportedMediaType_With_Null_Object_Parameter()
        {
            //Action
            var returned = testClient.PutAsync(requestURI, null).Result;
            var parsedResult = JsonConvert.DeserializeObject<AudsRiskDto>(returned.Content.ReadAsStringAsync().Result);
            //Assert
            Assert.Equal(HttpStatusCode.UnsupportedMediaType, returned.StatusCode);
            Assert.False(returned.IsSuccessStatusCode);
            Assert.NotNull(parsedResult);
            Assert.Equal(0, parsedResult.RiskId);
        }
        ...
        [Trait("Category", "Update")]
        [Trait("Category", "KO")]
        public void Update_AudsRisk_Return_BadRequest_With_Empty_Object_Parameter()
        {
            //Arrange
            var requestContent = new StringContent(JsonConvert.SerializeObject(new AudsRiskDto()), Encoding.UTF8, "application/json");
            //Action
        ...
        public void Create_AudsRisk_Return_OK()
        {
            //Arrange
            var listAllEntityDto = testClient.GetAsync(requestURI).Result;
            var entity = JsonConvert.DeserializeObject<List<AudsRisk>>(listAllEntityDto.Content.ReadAsStringAsync().Result)
                .OrderByDescending(x => x.RiskId).First();
            var IdLast = entity.RiskId;
            entity.RiskId = 0;

            AudsRisk newEntity = AudsRiskIntegrationDataTest.ResetEntityDto(entity);
            ...
            Assert.NotNull(parsedResult);
            Assert.IsType<AudsRiskDto>(parsedResult);
            //Assert.Equal(IdLast+1, parsedResult.RiskId);
        }
        ...
        public void Update_AudsRisk_Return_OK()
        {
            ...
            AudsRisk changedEntity = AudsRiskIntegrationDataTest.ResetEntityDto(entity);
        ...
        public void Delete_AudsRisk_Return_OK()
        {
            ...
            var listAllEntityDto = testClient.GetAsync(requestURI).Result;
            var entityDto = JsonConvert.DeserializeObject<List<AudsRiskDto>>(listAllEntityDto.Content.ReadAsStringAsync().Result)
                .Where(audsRisk => audsRisk.CodeStatus == true)
                .OrderByDescending(x => x.RiskId).First();
            ...
            var parsedResult = JsonConvert.DeserializeObject<AudsRiskDto>(returned.Content.ReadAsStringAsync().Result);
            //Assert
            Assert.Equal(entityDto.RiskId, parsedResult.RiskId);
